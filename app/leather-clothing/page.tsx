...
export default function LeatherClothing() {
  const products: Product[] = [
    { id: 1, name: "Leather Jacket", image: "/leather/jacket.jpg", description: "Classic leather jacket with timeless style and durability.", price: 25 },
     { id: 2, name: "Leather Vest", image: "/leather/vest.jpg", description: "Stylish leather vest for casual and formal outfits.", price: 45 },
    { id: 3, name: "Leather Coat", image: "/leather/coat.jpg", description: "Elegant long leather coat designed for style and warmth.", price: 55 },
    { id: 4, name: "Leather Pants", image: "/leather/pants.jpg", description: "Premium leather pants offering comfort and a modern look.", price: 35 },
    { id: 5, name: "Leather Skirt", image: "/leather/skirt.jpg", description: "Chic leather skirt suitable for trendy fashion looks.", price: 46 },
    { id: 6, name: "Leather Blazer", image: "/leather/blazer.jpg", description: "Modern leather blazer, perfect for office or evening wear.", price: 48 },
  ];
